...
class HomeModernPage extends React.Component {
    ...
    render(){
        ...
        <Header/>
            ...
            <FileData>
                <p>File - {data.allContentfulTheme.edges[0].node.styles[this.state.currentIndex].title}</p>
                <p>Format - {format}</p>
                <p>Size - </p>
            </FileData>
            <a href={data.allContentfulTheme.edges[0].node.styles[this.state.currentIndex].description}>
                <DownloadButton>
                    <p>DOWNLOAD</p>
...
export default HomeModernPage

export const query = graphql`
    query HomeModernDataQuery {
      allContentfulIcons{
        edges{
          node{
            title  
      ...
      allContentfulTheme(filter : { title: { eq: "Modern" } }){
        edges{
          node{
            styles{
              title
